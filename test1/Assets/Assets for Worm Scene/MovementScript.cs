...
{   
    ...
    void Update()
    {
        ...
        else if (inputx > 0) {smerx=1;smery=0;mySpriteRenderer.flipX = false;}
        else if (inputy > 0) {smerx=0;smery=1;}
        else if (inputy < 0) {smerx=0;smery=-1;}
    ...
    {
        if(col.tag=="Snake" || col.tag=="SnakeTail"){
           SceneManager.LoadScene("Worm Level");
           AppleSpawner.NumberOfSpawned = 0;
        }
    }
}
